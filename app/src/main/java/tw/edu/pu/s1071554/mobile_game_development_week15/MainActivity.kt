package tw.edu.pu.s1071554.mobile_game_development_week15
...
import tw.edu.pu.s1071554.mobile_game_development_week15.ui.theme.MobileGameDevelopmentWeek15Theme
import java.net.HttpURLConnection
import java.net.HttpURLConnection.HTTP_OK

class MainActivity : ComponentActivity() {
    val carurl =
        "https://www.streetcar.org/wp-content/uploads/sfmsr/streetcars/uploads/1080-ferrario.png"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            MobileGameDevelopmentWeek15Theme {
...
fun Greeting(name: String) {
    Column() {
        ...
        if (imgready.value) {
            Image(
                painter = BitmapPainter(img), contentDescription = "image",
                modifier = Modifier.fillMaxSize()
            )
        }
    }
